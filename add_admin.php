...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Insert admin record
    $stmt = $conn->prepare("INSERT INTO admins (user_id, first_name, last_name, email) VALUES (?, ?, ?, ?)");
    ...
    if($stmt->execute()) {
        ...
        $error = "Failed to add administrator: " . $stmt->error;
    }
}
...
<head>
    ...
    <title>Add New Administrator - Student Information System</title>
    <style>
        body {
        ...
        <div class="main-content">
            ...
            <div class="content-area">
                <div class="page-title">
                    ...
                    <a href="admins.php" class="back-btn">Cancel</a>
                </div>
                ...
                <form method="post">
                    ...
                    <div class="action-buttons">
                        <button type="submit" class="save-btn">Create Administrator</button>
