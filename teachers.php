...
$allowed_sort_fields = ['id', 'first_name', 'last_name', 'department_name', 'email', 'mobile_no'];
...
// Query to get teachers with department names
$query = "SELECT t.id, t.first_name, t.last_name, t.email, t.mobile_no, 
...
<head>
    ...
    <title>Teacher List - Student Information System</title>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><a href="?sort=mobile_no&order=<?php echo $sort_by == 'mobile_no' ? $toggle_order : 'ASC'; ?>" class="<?php echo $sort_by == 'mobile_no' ? strtolower($order) : ''; ?>">Mobile No</a></th>
                            <th>Username</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action-buttons">
                                <a href="profile_teacher.php?id=<?php echo $row['id']; ?>" class="view-btn">View</a>
                                <?php if ($role == 'admin'): ?>
                                    <a href="edit_teacher.php?id=<?php echo $row['id']; ?>" class="edit-btn">Edit</a>
                                    <a href="delete_teacher.php?id=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this teacher?')">Delete</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php
